          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center justify-center gap-4 my-8 animate-fade-in-delay-1">
              ...
              <div className="relative">
                <svg className="w-8 h-8 text-blue-600 animate-float" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="relative animate-fade-in-delay-2">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl transform rotate-1" />
              <div className="relative bg-white bg-opacity-70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100">
                <p className="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed font-light">
                  Explore our <span className="font-semibold text-blue-600">curated gallery</span> featuring 
                  detailed images of unique aircraft models. Each piece captures the 
                  <span className="font-semibold text-purple-600"> essence of aviation excellence</span>.
                </p>
              </div>
            </div>
